...
@AutoConfigureRestDocs(uriScheme = "https", uriHost = "my-host-machine", uriPort = 443)
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get",pathParameters(
                			parameterWithName("beerId").description("Unique id for Beer.")
                		),
                		requestParameters(
                				parameterWithName("isCold").description("isCold parameter")	
                		),
                        responseFields(
